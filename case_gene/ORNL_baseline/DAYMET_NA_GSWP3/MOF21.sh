...
DATA_ROOT="/gpfs/wolf2/cades/cli185/proj-shared/wangd/kiloCraft/NA_cases_data/NADaymet_GSWP3_2014/"
...
DOMAIN_FILE="${EXPID}_domain.lnd.Daymet_NA.1km.1d.c250531.nc"
SURFDATA_FILE="${EXPID}_surfdata.Daymet_NA.1km.1d.c250531.nc"
