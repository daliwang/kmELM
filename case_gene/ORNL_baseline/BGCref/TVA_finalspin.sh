...
EXPID="TVA"
CASEDIR="$E3SM_SRCROOT/e3sm_cases/uELM_${EXPID}_finalspinref"
...
./xmlchange RUN_STARTDATE="00501-01-01"
./xmlchange CONTINUE_RUN="FALSE"
./xmlchange RESUBMIT="1"

#### make sure the finidat point to the restart file you want to use from the ai4gbc run directory ###
echo "
finidat = '/gpfs/wolf2/cades/cli185/proj-shared/wangd/kmELM/e3sm_runs/uELM_TVA_adspinref/run/uELM_TVA_adspinref.elm.r.00501-01-01-00000.nc'
