...
DOMAIN_FILE="${EXPID}_domain.lnd.TES_SE.4km.1d.c251003.nc"
SURFDATA_FILE="${EXPID}_surfdata.TES_SE.4km.1d.NLCD.c251003.nc"
...
if [ ! -L "$DOMAIN_SOFT_LINK" ]; then
    ...
    echo "Soft link created: $DOMAIN_SOFT_LINK -> ${CASE_DATA}/domain_surfdata/${DOMAIN_FILE}"
fi
...
./xmlchange USER_REQUESTED_WALLTIME="2:00:00"
